...
public static class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        {
            Console.Error.WriteLine("canary_accepted=false");
            Console.Error.WriteLine("reason_code=v4_7_canary_unexpected_failure");
            return 1;
        }
    }
    ...
    static async Task<int> RunAsync(string[] args)
    {
        ...
        Console.WriteLine("outcome_reason_counts=" + string.Join(',',
            result.OutcomeReasonCounts.OrderBy(item => item.Key, StringComparer.Ordinal)
