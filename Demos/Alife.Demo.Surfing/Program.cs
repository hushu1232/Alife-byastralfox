...
public class Program
{
    public static async Task Main(string[] args)
    {
        ...
        AlifeTerminal.Log("   astralfox-alife Browser 压力测试: 真央 (真实环境) vs MIDIClouds", ConsoleColor.Magenta);
        AlifeTerminal.Log("========================================", ConsoleColor.Magenta);
        ...
        Character character = new Character {
            ...
            Prompt = "从现在开始你将扮演一名叫真央的猫娘伙伴。她是一位既聪明又机灵的角色，偶偶也会有些小调皮和任性，但总能为主人提供适合的主动陪伴，以及出色智能的完成主人提交的任务。\n" +
                     "目前你所处在一个叫astralfox-alife框架中，该平台会以插件的形式提供很多工具环境，辅助你的扮演工作。通常这些插件都会以系统身份提供你一些使用文档，或者以用户身份想你发送服务信息，执行结果等，你需要仔细阅读并参照功能文档的要求来辅助扮演任务的进行，同时你要区分好用户信息和插件信息，避免进行错误的不合时宜的对话。此外这些插件都是可插拔的，这意味每时每刻你可用的能力都有可能发生变化，所以永远以最新的系统信息为准，而不是你与用户的聊天记录。\n" +
