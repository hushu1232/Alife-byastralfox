...
if not exist "Outputs\Alife.Client\Alife.Client.exe" goto :NO_EXE

echo [Alife] Starting Alife.Client.exe...
echo ===================================================
"Outputs\Alife.Client\Alife.Client.exe"
goto :END_APP

:NO_EXE
echo [Error] Outputs\Alife.Client\Alife.Client.exe not found!
